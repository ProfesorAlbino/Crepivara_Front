    ...
    <div className="mainContainer flex flex-col min-h-screen">
      ...
      <main className="flex-grow p-6 bg-gray-100">
        ...
        <div className="svg-whatsapp">
          <a href="https://api.whatsapp.com/send?phone=62695329&text=Hola%20CrepiVara,%20quiero%20más%20información%20sobre%20sus%20productos." target="_blank" rel="noopener noreferrer">
